...
let process1: string, process2: string, process3: string, process4: string;
try { process1 = new URL("../assets/process1.png", import.meta.url).href; } catch { process1 = ""; }
try { process2 = new URL("../assets/process2.png", import.meta.url).href; } catch { process2 = ""; }
try { process3 = new URL("../assets/process3.png", import.meta.url).href; } catch { process3 = ""; }
try { process4 = new URL("../assets/process4.png", import.meta.url).href; } catch { process4 = ""; }
...
export function Process() {
  ...
  return (
    <div ref={containerRef} className="relative h-[480vh] bg-black">
      ...
      <div className="sticky top-0 h-screen w-full bg-black text-white flex flex-col overflow-hidden py-12 px-6 md:px-12">
        ...
        >
          ...
          {/* Main Heading */}
          <h2 
            className="text-center font-black uppercase tracking-tight leading-[0.95] max-w-4xl"
            style={{ fontSize: "clamp(24px, 4vw, 54px)" }}
          >
            A SIMPLE PROCESS FOR<br />AI DISCOVERY
          </h2>
        </motion.div>
