...
export function Contact() {
  return (
    <section id="contact" className="relative py-24 px-6 md:px-12 lg:px-20 min-h-[750px] flex items-center justify-center overflow-hidden bg-black text-white border-t border-white/[0.05]">
